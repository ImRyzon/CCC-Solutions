...
public class Main {
    ...
    public static void main(String[] args) throws Exception {
        ...
        String line1 = r.readLine(), line2 = r.readLine(), line3 = r.readLine();
        for (int i = 0; i < line2.length(); i++) {
            if (!dict.containsKey(line2.charAt(i))) dict.put(line2.charAt(i), line1.charAt(i));
        }
        for (int i = 0; i < line3.length(); i++) {pr.print(dict.getOrDefault(line3.charAt(i), '.'));}
        pr.println(); pr.close();
    }
