...
public class Main {
    ...
    public static void main(String[] args) throws Exception {
        ...
        while (!line.equals("SCHOOL")) {
            line = r.readLine();
            if (line.equals("SCHOOL")) break;
            if (line.equals("R")) directions.add("LEFT");
            else if (line.equals("L")) directions.add("RIGHT");
            else directions.add(line);
        }
        for (int i = directions.size()-1; i >= 0; i--) {
            pr.println("Turn " + directions.get(i) + " onto " + directions.get(--i) + " street.");
            if (i == 1) {pr.println("Turn " + directions.get(0) + " into your HOME."); break;}
        }
        pr.close();
    }
